...
typedef ::testing::Types<
    Problem<1, 1, 32, 32, 3, 1, 1>, Problem<1, 2, 32, 32, 3, 1, 1>,
    Problem<4, 2, 32, 32, 3, 1, 1>, Problem<1, 1, 64, 64, 3, 1, 1>,
    Problem<1, 1, 28, 28, 3, 1, 1>, Problem<1, 10, 128, 128, 3, 1, 1>,
    Problem<1, 1, 30, 30, 3, 1, 1>, Problem<1, 1, 64, 64, 3, 1, 2>,
    Problem<1, 1, 60, 60, 3, 1, 2>, Problem<1, 1, 56, 56, 3, 1, 2>,
    Problem<1, 1, 128, 128, 3, 1, 2>, Problem<1, 2, 112, 112, 3, 1, 2>,
    // MobileNetV1 width 1.8
    Problem<1, 56, 112, 112, 3, 1, 1>, Problem<1, 115, 112, 112, 3, 1, 2>,
    Problem<1, 232, 56, 56, 3, 1, 1>, Problem<1, 232, 56, 56, 3, 1, 2>,
    Problem<1, 464, 28, 28, 3, 1, 1>, Problem<1, 464, 28, 28, 3, 1, 2>,
    Problem<1, 920, 14, 14, 3, 1, 1>, Problem<1, 920, 14, 14, 3, 1, 2>,
    Problem<1, 1840, 7, 7, 3, 1, 1>,
    // MobileNetV1 width 1.7
    Problem<1, 56, 112, 112, 3, 1, 1>, Problem<1, 108, 112, 112, 3, 1, 2>,
    Problem<1, 216, 56, 56, 3, 1, 1>, Problem<1, 216, 56, 56, 3, 1, 2>,
    Problem<1, 432, 28, 28, 3, 1, 1>, Problem<1, 432, 28, 28, 3, 1, 2>,
    Problem<1, 872, 14, 14, 3, 1, 1>, Problem<1, 872, 14, 14, 3, 1, 2>,
    Problem<1, 1744, 7, 7, 3, 1, 1>,
    // MobileNet width 1.6
    Problem<1, 48, 112, 112, 3, 1, 1>, Problem<1, 102, 112, 112, 3, 1, 2>,
    Problem<1, 208, 56, 56, 3, 1, 1>, Problem<1, 208, 56, 56, 3, 1, 2>,
    Problem<1, 408, 28, 28, 3, 1, 1>, Problem<1, 408, 28, 28, 3, 1, 2>,
    Problem<1, 816, 14, 14, 3, 1, 1>, Problem<1, 816, 14, 14, 3, 1, 2>,
    Problem<1, 1640, 7, 7, 3, 1, 1>,
    // MobileNet width 1.5
    Problem<1, 48, 112, 112, 3, 1, 1>, Problem<1, 96, 112, 112, 3, 1, 2>,
    Problem<1, 192, 56, 56, 3, 1, 1>, Problem<1, 192, 56, 56, 3, 1, 2>,
    Problem<1, 384, 28, 28, 3, 1, 1>, Problem<1, 384, 28, 28, 3, 1, 2>,
    Problem<1, 768, 14, 14, 3, 1, 1>, Problem<1, 768, 14, 14, 3, 1, 2>,
    Problem<1, 1536, 7, 7, 3, 1, 1>,
    // MobileNet width 1.4
    Problem<1, 48, 112, 112, 3, 1, 1>, Problem<1, 89, 112, 112, 3, 1, 2>,
    Problem<1, 176, 56, 56, 3, 1, 1>, Problem<1, 176, 56, 56, 3, 1, 2>,
    Problem<1, 360, 28, 28, 3, 1, 1>, Problem<1, 360, 28, 28, 3, 1, 2>,
    Problem<1, 720, 14, 14, 3, 1, 1>, Problem<1, 720, 14, 14, 3, 1, 2>,
    Problem<1, 1432, 7, 7, 3, 1, 1>,
    // MobileNet width 1.3
    Problem<1, 40, 112, 112, 3, 1, 1>, Problem<1, 83, 112, 112, 3, 1, 2>,
    Problem<1, 168, 56, 56, 3, 1, 1>, Problem<1, 168, 56, 56, 3, 1, 2>,
    Problem<1, 336, 28, 28, 3, 1, 1>, Problem<1, 336, 28, 28, 3, 1, 2>,
    Problem<1, 664, 14, 14, 3, 1, 1>, Problem<1, 664, 14, 14, 3, 1, 2>,
